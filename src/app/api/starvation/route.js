...
export const POST = async (request) => {
  ...
  console.log({seeker_name, seeker_email, seeker_image, location, phone_no, deadline, amount, emergency, verification, reason, supermarket_name, supermarket_location, supermarket_contact_number});
