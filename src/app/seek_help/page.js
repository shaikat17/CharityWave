...
const SeekHelp  = () => {
    ...
    const onSubmit = data => {
        ...
        if (category === 'Education') {
            console.log({
                amount, deadline, institution_name, institution_location, institution_contact_number,  location,
                sub_category, bookStore_name,bookStore_location,bookStore_contact_number,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card lg:w-[60%] mx-5 shadow-2xl bg-base-100 lg:mx-auto mt-8 mb-10">
            ...
            <div className="card-body">
                ...
                <div className='flex flex-col lg:flex-row justify-between items-center gap-5'>
                    ...
                    {/* //for medical category show this sub categories */}
                    {
                        category === 'Medical' && <div className="form-control w-full flex-row items-center">
                            <label className="label cursor-pointer justify-normal gap-2">
                                <input type="radio" checked={sub_category === 'Hospital'} onChange={() => setSub_category('Hospital')}
                                    className="radio checked:bg-red-500" />
                                <span className="label-text">Medical related</span>
                            </label>

                            <label className="label cursor-pointer justify-normal gap-2">
                                <input type="radio" checked={sub_category === 'Pharmacy'} onChange={() => setSub_category('Pharmacy')}
                    ...
                    {
                        category === 'Education' && <div className="form-control w-full flex-row items-center">
                            <label className="label cursor-pointer justify-normal gap-2">
                                <input type="radio" checked={sub_category === 'Institution'} onChange={() => setSub_category('Institution')}
                                    className="radio checked:bg-red-500" />
                                <span className="label-text">Institution related</span>
                            </label>

                            <label className="label cursor-pointer justify-normal gap-2">
                                <input type="radio" checked={sub_category === 'Bookstore'} onChange={() => setSub_category('Bookstore')}
                                    className="radio checked:bg-blue-500" />
                                <span className="label-text">Book Buying related</span>
                            </label>
                            {errors.sub_category?.type === 'required' && <p role="alert" className='text-red-700'>This field is required</p>}
                        </div>
                    }
                ...
                {/* //for Starvation category show these fields */}
                {
                    ...
                    <>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" {...register("supermarket_name", { required: true })} name='supermarket_name' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.supermarket_name?.type === 'required' && <p role="alert" className='text-red-700'> supermarket_name is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">supermarket location</span>
                            </label>
                            <input type="text" {...register("supermarket_location", { required: true })} name='supermarket_location' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.supermarket_location?.type === 'required' && <p role="alert" className='text-red-700'> supermarket_location is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">supermarket contact_number</span>
                            </label>
                            <input type="text" {...register("supermarket_contact_number", { required: true })} name='supermarket_contact_number' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.supermarket_contact_number?.type === 'required' && <p role="alert" className='text-red-700'> supermarket_contact_number is required</p>}
                        </div>
                    </>
                }
                ...
                {/* //sub categories fields */}
                {
                    ...
                    <>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" {...register("hospital_name", { required: true })} name='hospital_name' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.hospital_name?.type === 'required' && <p role="alert" className='text-red-700'> hospital_name is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Hospital location</span>
                            </label>
                            <input type="text" {...register("hospital_location", { required: true })} name='hospital_location' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.hospital_location?.type === 'required' && <p role="alert" className='text-red-700'> hospital_location is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Hospital contact_number</span>
                            </label>
                            <input type="text" {...register("hospital_contact_number", { required: true })} name='hospital_contact_number' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.hospital_contact_number?.type === 'required' && <p role="alert" className='text-red-700'> hospital_contact_number is required</p>}
                        </div>
                    </>
                }
                {sub_category === 'Pharmacy' && category === 'Medical' &&
                    <>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" {...register("pharmacy_name", { required: true })} name='pharmacy_name' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.pharmacy_name?.type === 'required' && <p role="alert" className='text-red-700'> pharmacy_name is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Pharmacy location</span>
                            </label>
                            <input type="text" {...register("pharmacy_location", { required: true })} name='pharmacy_location' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.pharmacy_location?.type === 'required' && <p role="alert" className='text-red-700'> pharmacy_location is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Pharmacy contact_number</span>
                            </label>
                            <input type="text" {...register("pharmacy_contact_number", { required: true })} name='pharmacy_contact_number' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.pharmacy_contact_number?.type === 'required' && <p role="alert" className='text-red-700'> pharmacy_contact_number is required</p>}
                        </div>
                    </>
                }
                {
                ...
                {sub_category === 'Bookstore' && category === 'Education' &&
                    <>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" {...register("bookStore_name", { required: true })} name='bookStore_name' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.bookStore_name?.type === 'required' && <p role="alert" className='text-red-700'> bookStore_name is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Bookstore location</span>
                            </label>
                            <input type="text" {...register("bookStore_location", { required: true })} name='bookStore_location' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.bookStore_location?.type === 'required' && <p role="alert" className='text-red-700'> bookStore_location is required</p>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Bookstore contact_number</span>
                            </label>
                            <input type="text" {...register("bookStore_contact_number", { required: true })} name='bookStore_contact_number' placeholder="Enter Toy Name" className="input input-bordered" />
                            {errors.bookStore_contact_number?.type === 'required' && <p role="alert" className='text-red-700'> bookStore_contact_number is required</p>}
                        </div>
                    </>
                }
